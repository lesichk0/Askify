...
const ConsultationRequestsPage: React.FC = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold text-gray-800 mb-6">Open Consultation Requests</h1>
      ...
      {loading ? (
        ...
        <div className="bg-gray-50 p-8 rounded-lg text-center">
          ...
          <h2 className="text-xl font-semibold text-gray-700 mb-2">No Open Requests</h2>
          <p className="text-gray-500">There are currently no open consultation requests.</p>
        </div>
      ) : (
